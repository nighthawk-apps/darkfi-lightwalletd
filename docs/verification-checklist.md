...
- [x] UnifOMR detection_keys cap raised to 16
...
- [ ] Sender without LWD / UnifOMR path fails closed (no legacy scheme)
- [ ] Receiver without UnifOMR matches discovers via trial decrypt
